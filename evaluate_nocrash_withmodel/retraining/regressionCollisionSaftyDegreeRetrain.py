...
def reTrainCollisionSaftyDegreeModel(modelPath,MinMaxScalerPath,data_path,label_name):
...
if __name__ == "__main__":
    ...
    modelPath = "../model/Torch/CollisionCARLA_SUN_SaftyDegree_BEST.pth"
    MinMaxScalerPath = "../regression_code/retrainedRegressionCollisionSaftyDegreeMinMaxScaler_1.pt"
    reTrainCollisionSaftyDegreeModel(modelPath,MinMaxScalerPath,data_path,label_name)

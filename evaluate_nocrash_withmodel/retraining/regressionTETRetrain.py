...
def reTrainTETModel(modelPath,MinMaxScalerPath,data_path,label_name):
    ...
    model = RegressionModelTET(input_dim=X_train.shape[1])
...
if __name__ == "__main__":
    ...
    label_name = "TET"
    modelPath = "../model/Torch/CARLA_SUN_TET_BEST.pth"
    MinMaxScalerPath = "../model/minmax/minmax_scaler_model_best.pkl"
    reTrainTETModel(modelPath,MinMaxScalerPath,data_path,label_name)

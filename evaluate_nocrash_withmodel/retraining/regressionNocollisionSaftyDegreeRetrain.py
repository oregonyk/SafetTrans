...
from evaluate_nocrash_withmodel.regression_code.RegressionModel import RegressionModelSaftyDegree
...
def reTrainNocollisionSaftyDegreeModel(modelPath,MinMaxScalerPath,data_path,label_name):
    ...
    layers_to_freeze = [0, 1, 2, 3, 4, 5]  # 索引从0开始，对应需要冻结的层
    layer_count = 0
...
def find_available_filename(folder_path,label,type = "Torch"):
    ...
    model_name = f"retrainedRegressionNocollision{label}{type}_{model_counter}.pt"
...
if __name__ == "__main__":
    ...
    modelPath = "../model/Torch/NocollisionCARLA_SUN_SaftyDegree_BEST.pth"
    MinMaxScalerPath = "../regression_code/retrainedRegressionNocollisionSaftyDegreeMinMaxScaler_1.pt"
    reTrainNocollisionSaftyDegreeModel(modelPath,MinMaxScalerPath,data_path,label_name)

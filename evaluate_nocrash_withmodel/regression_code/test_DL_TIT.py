...
def load_model(model_path, input_dim):
    model = RegressionModelTIT(input_dim=input_dim)
...
def predict(model, data_path, label_name):
    ...
    scaler = MinMaxScaler()
    scaler_path = "retrainedRegressionMinMaxScaler_1.pt"
...
def getTIT(x,modelPath,MinMaxScalerPath):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--label_name", type=str, default="TIT", help="Label name to be expected")
    parser.add_argument("--model_path", type=str, default="../model/Torch/CARLA_SUN_2.pth",
    ...
    modelPath = "../retraining/retrainedRegressionTITTorch_1.pt"
    MinMaxScalerPath = "retrainedRegressionMinMaxScaler_1.pt"
    x= [[5733.597,0.125,    1.851  ,  0.21   ,  0.347   ,10.   , 2627.511   , 0.232,    3.318 ,   0.296 ,  35.5  , 1634.117]]
    getTIT(x, modelPath, MinMaxScalerPath)
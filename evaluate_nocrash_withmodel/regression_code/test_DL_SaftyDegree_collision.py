...
def predict(model, data_path, label_name):
    ...
    scaler = MinMaxScaler()
    scaler_path = "retrainedRegressionCollisionSaftyDegreeMinMaxScaler_1.pt"
...
def getCollision(x,modelPath,MinMaxScalerPath):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", type=str, default="../model/Torch/CollisionCARLA_SUN_SaftyDegree_BEST.pth",

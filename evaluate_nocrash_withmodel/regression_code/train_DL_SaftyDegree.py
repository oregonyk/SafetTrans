...
from RegressionModel import RegressionModelTIT, BinaryModelSaftyDegree
...
def train(data_path, label_name):
    ...
    # After reading and preprocessing your data, apply SMOTE
    ...
    num_epochs = 250
    best_model_path = ""
    best_test_acc = 0.4  # too small means useless
...
def generate_model_name(data_path, folder_path, label):
    ...
    model_counter = 1
    model_name = f"{filename}_{label}_{model_counter}.pth"

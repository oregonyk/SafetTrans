...
from evaluate_nocrash_withmodel.regression_code.RegressionModel import RegressionModelTET
...
def load_model(model_path, input_dim):
    model = RegressionModelTET(input_dim=input_dim)
...
def getTET(x,modelPath,MinMaxScalerPath):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--label_name", type=str, default="TET", help="Label name to be expected")

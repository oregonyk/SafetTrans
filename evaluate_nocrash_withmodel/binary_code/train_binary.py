...
def train(args):
    ...
    model_path = f"../model/"+os.path.splitext(os.path.basename(args.data_path))[0]+"_binary_"+str(model_counter)+".pt"
    while os.path.exists(model_path):
        model_counter += 1
        model_path = "../model/"+os.path.splitext(os.path.basename(args.data_path))[0]+str(model_counter)+".pt"

...
class NoCrashEvalScenario(RouteScenario):
    ...
    def _set_route(self, hop_resolution=1.0):
        ...
        #crossover turn right 23,11.10
        #start = Transform(Location(x=324.010, y=198.3063, z=0.0333), Rotation(pitch=0.005, yaw=-179.2628, roll=0.000))
        #target = Transform(Location(x=335.3134, y=220.4802, z=0.033), Rotation(pitch=0.000, yaw=-179.3134, roll=-0.00))
        start = Transform(Location(x=324.010, y=198.3063, z=0.0333), Rotation(pitch=0.005, yaw=-179.2628, roll=0.000))
    ...
    def _initialize_actors(self, config):
        ...
        if self.town_name == 'Town01' and car_amount == 0 and ped_amount == 0:
            ...
            #spawn_point_one = Transform(Location(x=334.670166, y=190.948956, z=0.30000), Rotation(pitch=0, yaw=90.999756, roll=0))
            spawn_point_one = Transform(Location(x=334.670166, y=190.948956, z=0.30000),
                                        Rotation(pitch=0, yaw=90.999756, roll=0))

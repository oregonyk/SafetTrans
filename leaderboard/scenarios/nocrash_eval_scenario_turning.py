...
class NoCrashEvalScenario(RouteScenario):
    ...
    def _set_route(self, hop_resolution=1.0):
        ...
        start = Transform(Location(x=319.010, y=198.3063, z=0.0333), Rotation(pitch=0.005, yaw=-179.2628, roll=0.000))
    ...
    def _initialize_actors(self, config):
        ...
        #mjw 11.15
        car_amount = 1
        car_trans = [Transform(Location(x=334.670166, y=192.248956, z=0.30000),

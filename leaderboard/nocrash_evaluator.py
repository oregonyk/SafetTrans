...
class NoCrashEvaluator(object):
    ...
    def _load_and_run_scenario(self, args, route, weather_idx, traffic_idx, physics):
        ...
        print("\n\033[1m========= Preparing {} {}: {} to {}, weather {} =========".format(args.town, traffic_lvl,
                                                                                          ...
                                                                                          weather_idx))
        print("> Setting up the agent\033[0m",end="\t")
        ...
        print("\033[1m> Loading the world\033[0m",end="\t")
        ...
        print("\033[1m> Running the route\033[0m",end="\t")
        ...
        # Stop the scenario
        try:
            print("\033[1m> Stopping the route\033[0m",end='')
            self.manager.stop_scenario()
            # get distance/ speed
            distance = self.manager.get_nocrash_objective_data()
            TIT, TET, acc , TLCT, ALCJ, JerkAVG, yaw= self.manager.get_nocrash_analyze_data()
            #print("distance:", distance, " TIT:", TIT, " TET:", TET, " acc:", acc, "TLCT:", TLCT, "ALCT:", ALCJ, "JerkAVG:", JerkAVG, "yaw: Collected", yaw)
            print("distance:", distance, " TIT:", TIT, " TET:", TET, " acc:", acc, "TLCT:", TLCT, "ALCT:", ALCJ, "JerkAVG:", JerkAVG, "yaw: Collected")
        ...
        #     sys.exit(-1)
        # safevar save as TIT TET, but I write it in wrong rank. So the original data should be TITTET, the added dataset is TETTIT
        return distance, TET, TIT, acc , TLCT, ALCJ, JerkAVG, yaw
    ...
    def run(self, args, physics):
        ...
        # for i in range(5):
        result, TET, TIT, acc, TLCT, ALCJ ,JerkAVG,yaw = self._load_and_run_scenario(args, (19, 28), 8, 0, physics)
        # save global statistics
        #print("\033[1m> Registering the global statistics\033[0m")
        return result, TET, TIT, acc, TLCT, ALCJ ,JerkAVG, yaw
